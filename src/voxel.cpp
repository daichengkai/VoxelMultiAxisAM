...
bool
VoxelGrid::checkIsolated(std::vector<voxel *> &voxels, double radius, std::vector<std::vector<voxel *> > &clusters) {
...
void
VoxelGrid::findVoxelsOnConvex(const Eigen::MatrixXd &CV, const Eigen::MatrixXi &CF, std::vector<voxel *> &all_voxels,
